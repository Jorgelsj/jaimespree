...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<spree_api>.freeze, ["= 3.2.0"])
      s.add_runtime_dependency(%q<spree_backend>.freeze, ["= 3.2.0"])
      s.add_runtime_dependency(%q<spree_frontend>.freeze, ["= 3.2.0"])
      s.add_runtime_dependency(%q<spree_sample>.freeze, ["= 3.2.0"])
      s.add_runtime_dependency(%q<spree_cmd>.freeze, ["= 3.2.0"])
    else
      s.add_dependency(%q<spree_core>.freeze, ["= 3.2.0"])
      s.add_dependency(%q<spree_api>.freeze, ["= 3.2.0"])
      s.add_dependency(%q<spree_backend>.freeze, ["= 3.2.0"])
      s.add_dependency(%q<spree_frontend>.freeze, ["= 3.2.0"])
      s.add_dependency(%q<spree_sample>.freeze, ["= 3.2.0"])
      s.add_dependency(%q<spree_cmd>.freeze, ["= 3.2.0"])
    end
  else
    s.add_dependency(%q<spree_core>.freeze, ["= 3.2.0"])
    s.add_dependency(%q<spree_api>.freeze, ["= 3.2.0"])
