...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<state_machines-activemodel>.freeze, [">= 0.3.0"])
      s.add_runtime_dependency(%q<activerecord>.freeze, ["< 5.1", ">= 4.1"])
      ...
      s.add_dependency(%q<state_machines-activemodel>.freeze, [">= 0.3.0"])
      s.add_dependency(%q<activerecord>.freeze, ["< 5.1", ">= 4.1"])
