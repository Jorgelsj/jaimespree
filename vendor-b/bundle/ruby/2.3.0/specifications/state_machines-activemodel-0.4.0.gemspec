...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<state_machines>.freeze, [">= 0.4.0"])
      s.add_runtime_dependency(%q<activemodel>.freeze, ["< 5.1", ">= 4.1"])
      ...
      s.add_dependency(%q<state_machines>.freeze, [">= 0.4.0"])
      s.add_dependency(%q<activemodel>.freeze, ["< 5.1", ">= 4.1"])
